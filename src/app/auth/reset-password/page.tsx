...
import { LoaderCircle, KeyRound, AlertCircle, CheckCircle2 } from "lucide-react";
import Link from "next/link";
import { useResetPassword } from "@/hooks/ui/use-auth";
  ...
  return (
    <div className="relative">
      <div className="text-center mb-6">
        ...
        <h1 className="mb-2 text-2xl font-bold font-heading">Tạo mật khẩu mới</h1>
