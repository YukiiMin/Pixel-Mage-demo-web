			...
			<div className="container mx-auto px-4 pt-8 pb-12">
				<div className="text-center max-w-3xl mx-auto">
					...
					<p className="text-muted-foreground text-lg leading-relaxed">
						Mỗi bộ bài Tarot là một tác phẩm nghệ thuật độc đáo, được minh họa
						bởi các nghệ sĩ tài năng. Khám phá và sưu tầm những lá bài đẹp nhất
						từ các bộ sưu tập nổi tiếng thế giới.
					</p>
				</div>
			</div>
