		...
		<div className="space-y-6">
			...
			<div>
				...
				<p className="text-sm text-muted-foreground mt-0.5">
					Quản lý toàn bộ thẻ NFC vật lý trong hệ thống — chỉ Mobile mới có thể
					gán NFC
				</p>
			</div>
			...
			<div className="grid grid-cols-6 gap-3">
				{[
					...
					{
						label: "Sẵn sàng",
						value: statCounts.ready,
						icon: ShieldCheck,
						color: "text-green-400",
					},
					{
						label: "Đã bán",
						value: statCounts.sold,
						icon: Package,
						color: "text-amber-400",
					},
					{
						label: "Đã gắn NFC",
						value: statCounts.linked,
						icon: Smartphone,
						color: "text-secondary",
					},
					{
						label: "Vô hiệu hóa",
						value: statCounts.deactivated,
						icon: ShieldOff,
					...
					<div
						key={stat.label}
						className="glass-card rounded-xl px-3 py-3 flex items-center gap-2"
					>
						<stat.icon className={`h-4 w-4 shrink-0 ${stat.color}`} />
						<div className="min-w-0">
							<p className="font-stats text-lg font-semibold text-foreground leading-none">
								{stat.value}
							</p>
						...
						<Table>
							<TableHeader>
								<TableRow className="border-border hover:bg-transparent">
									<TableHead className="text-xs uppercase tracking-wider text-muted-foreground font-medium w-32">
										NFC UID
									</TableHead>
									<TableHead className="text-xs uppercase tracking-wider text-muted-foreground font-medium w-24">
										Serial
									</TableHead>
									<TableHead className="text-xs uppercase tracking-wider text-muted-foreground font-medium w-28">
										Batch
									</TableHead>
			...
			<div className="glass-card rounded-xl p-4 border-l-2 border-secondary flex items-start gap-3">
				...
				<p className="text-sm text-muted-foreground">
					...
					hiển thị đầy đủ thông tin thẻ vật lý cho Admin. Việc gán NFC vào thẻ
					phải được thực hiện từ <strong>ứng dụng Mobile</strong>.
				</p>
			</div>
		</div>
	);
