      ...
      <CardContent>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {quickNavItems.map((item, index) => (
            ...
            >
              <Link href={item.href}>
                <div className={`p-4 rounded-xl bg-gradient-to-br ${item.bgGradient} border border-white/10 hover:border-white/20 backdrop-blur-sm hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer group`}>
                  <div className="flex flex-col items-center text-center space-y-2">
                    <div className={`p-3 rounded-lg bg-gradient-to-r ${item.color} text-white shadow-lg group-hover:shadow-xl transition-shadow`}>
