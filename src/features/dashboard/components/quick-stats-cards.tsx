		...
		<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
			{stats.map((stat, index) => (
				...
				>
					<Link href={stat.href}>
						<Card
							className={`bg-gradient-to-br ${stat.bgGradient} border border-white/10 backdrop-blur-sm hover:shadow-lg transition-all duration-300 hover:scale-105 cursor-pointer group`}
						>
